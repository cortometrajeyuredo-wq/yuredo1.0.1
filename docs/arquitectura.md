...
- /src/data: Almacena datos en array, pe.: equipo.ts, blogs.ts.
...
- Las variables y las funciones deben ser dicientes, es decir, su declaración debe indicar a que refiere o que dato almacena.
- Todas las imágenes deben estar en formato webp con peso alredor de los 200k o incluso menor.
