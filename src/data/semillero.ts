...
export const slidesSemillero: ElementoSemillero[] = [
    {
        src: '/static/img/seccion2_motmot/semlleroPrincipal.webp',
    ...
    {
        src: '/static/img/seccion2_motmot/MotMot_Semillero_01.webp',
    ...
    {
        src: '/static/img/seccion2_motmot/MotMot_Semillero_02.webp',
    ...
    {
        src: '/static/img/seccion2_motmot/MotMot_Semillero_03.webp',
    ...
    {
        src: '/static/img/seccion2_motmot/MotMot_Semillero_04.webp',
    ...
    {
        src: '/static/img/seccion2_motmot/MotMot_Semillero_05.webp',
