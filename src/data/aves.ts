/**
 * @módulo Aves
 * @descripción Datos de las aves del Museo Virtual de Aves del Vaupés.
 * @arquitectura src/data/aves.ts
 */

/**
 * Representa una especie de ave en el museo.
 */
...
/**
 * Colección de aves mostradas en la sección Museo.
 */
export const aves: Ave[] = [
    {
        src: '/static/img/seccion5_museo/MotMot_Aves_01.webp',
    ...
    {
        src: '/static/img/seccion5_museo/MotMot_Aves_02.webp',
    ...
    {
        src: '/static/img/seccion5_museo/MotMot_Aves_03.webp',
    ...
    {
        src: '/static/img/seccion5_museo/MotMot_Aves_04.webp',
    ...
    {
        src: '/static/img/seccion5_museo/MotMot_Aves_05.webp',
    ...
    {
        src: '/static/img/seccion5_museo/MotMot_Aves_06.webp',
    ...
    {
        src: '/static/img/seccion5_museo/MotMot_Aves_07.webp',
    ...
    {
        src: '/static/img/seccion5_museo/MotMot_Aves_08.webp',
    ...
    {
        src: '/static/img/seccion5_museo/MotMot_Aves_09.webp',
        titulo: 'Topaza Pella',
    ...
    {
        src: '/static/img/seccion5_museo/MotMot_Aves_10.webp',
    ...
    {
        src: '/static/img/seccion5_museo/MotMot_Aves_11.webp',
