...
const SeccionEtno = () => {
    ...
    const imagenesSlider = [
        '/static/img/seccion-etno/etno-ornitologia-02.webp',
        '/static/img/seccion-etno/etno-ornitologia-03.webp',
        '/static/img/seccion-etno/etno-ornitologia-01.webp',
        '/static/img/seccion-etno/etno-ornitologia-04.webp',
    ];
    return (
        <section className={styles.section4} id="etno">
            ...
            <img src="/static/img/seccion-etno/star-sect-etno-sup-izq.svg" className={styles.starSupIzq} alt="" />
            <img src="/static/img/seccion-etno/star-sect-etno-sup-der.svg" className={styles.starSupDer} alt="" />
            ...
            <div className={styles.contenedor_section4_1}>
                <div className={styles.start_sect4_arriba}>
                    <img src="/static/img/seccion-etno/start-sect-etno-arriba.svg" alt="" />
                </div>
                <div className={styles.start_sect4_arriba}>
                    <img src="/static/img/seccion-etno/start-sect-etno-arriba.svg" alt="" />
                </div>
            ...
            <div className={styles.contenedor_section4_3}>
                <div className={styles.uno}>
                    <div className={styles.uno1}>
                        <a href="/static/files/cartillas-etno.zip" download="cartillas-etno.zip">
                ...
                <div className={styles.dos}>
                    ...
                    <div className={styles.dos4}>
                        <img src="/static/img/seccion-etno/star-etno-1.svg" alt="" />
                    </div>
                </div>
                <div className={styles.sect4_tres}>
                    ...
                    <div className={styles.star_sect4_centro}>
                        <img src="/static/img/seccion-etno/start-etno.svg" alt="" />
                    </div>
                ...
                <div className={styles.cuatro}>
                    ...
                    <div className={styles.estrellas}>
                        <img src="/static/img/seccion-etno/start-etno-2.svg" alt="" />
                    </div>
                </div>
            </div>
        </section>
