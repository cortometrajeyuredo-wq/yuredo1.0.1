    ...
    return (
        <section className={styles.section2} id="motmot">
            ...
            <div className={`${styles.dianas} ${styles.dianas_desktop}`}>
                <img src="/static/img/seccion-motmot/dianas-sect-motmot.svg" alt="" />
            </div>
            <div className={styles.contenedor_section2_1}>
                <div className={styles.estrella2_1}>
                    <img src="/static/img/seccion-motmot/star-motmot-1.svg" alt="" />
                </div>
                <div className={styles.estrella2_2}>
                    <img src="/static/img/seccion-motmot/start-motmot-2.svg" alt="" />
                </div>
                <div className={styles.estrella2_3}>
                    <img src="/static/img/seccion-motmot/start-motmot-4.svg" alt="" />
                </div>
            </div>
            ...
            <div className={styles.fila_intermedia_mobile}>
                <div className={styles.ave_mobile}>
                    <img src="/static/img/seccion-motmot/ave-sec-motmot-responsive.svg" alt="Ave decorativa" />
                </div>
            </div>
            ...
            <div className={styles.palmera_mobile}>
                <img src="/static/img/seccion-motmot/palmera-sec-motmot-responsive.svg" alt="Palmera decorativa" />
            </div>
